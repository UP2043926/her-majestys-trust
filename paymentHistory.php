    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="text-center" style="text-align: center;">Sender</th>
                <th class="text-center" style="text-align: center;">Receiver</th>
                <th class="text-center" style="text-align: center;">Amount</th>
                <th class="text-center" style="text-align: center;">Time Stamp</th>
            </tr>
        </thead>
        <tbody>
        <?php
        ...
        ?>
            ...
            <td class="py-2" style="text-align: center;"><?php echo $rows['timeStamp']; ?> </td>
